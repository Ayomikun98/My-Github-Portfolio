...
function RepoDetails() {
  ...
  useEffect(() => {
    fetch(`https://api.github.com/repos/Ayuomikun98/${id}`)
  ...
  useEffect(() => {
    fetch(`https://api.github.com/repos/Ayomikun98/${id}/branches`)
    .then((response) => (response.json()))
    .then((data) => {
      setBranch(data)
    })
  ...
  useEffect(() => {
    fetch(`https://api.github.com/repos/Ayomikun98/${id}/deployments`)
    .then((response) => (response.json()))
    .then((data) => {
      setDeployment(data)
    })
